...
public class Step08Query {
    ...
    public void searchByPhraseQuery() {
        try {
            ...
            output(new IndexSearcher(reader), query);
            /*
             * (4-1.0166318)email:ee@sinobot.org,name:mike,attach:5,date:1494572400000
             * (3-0.5083159)email:dd@sina.org,name:jetty,attach:4,date:1463036400000
             */
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void searchByFuzzyQuery() {
        try {
            ...
            output(new IndexSearcher(reader), query);
            /*
             * (4-2.0986123)email:ee@sinobot.org,name:mike,attach:5,date:1494572400000
             */
        } catch (IOException e) {
            e.printStackTrace();
        }
